		...
		const ACHIEVEMENT_REQUIREMENTS = {
			'❤️ 喜结良缘': '顺利毕业且与异性学者发展为恋人关系（社交≥12后在开会时多次交流同一人）',
			'💰 家财万贯': '顺利毕业且结局时金币≥30',
			...
			'🤖 论文机器': '顺利毕业且发表论文总数≥10',
			'📚 千引大佬': '顺利毕业且总引用数≥1000',
			'☕ 绝世咖啡': '顺利毕业且冰美式效果达到SAN+6（需购买45杯以上）',
			...
			'🎣 力挽狂澜': '顺利毕业且曾在审稿总分为-1时被PC捞起录用',
			'💔 不入爱河': '顺利毕业且两次拒绝聪慧恋人或活泼恋人，且最后没有恋爱',
			'💕 我在等你': '顺利毕业且两次拒绝聪慧恋人或活泼恋人，且最后恋爱了',
			'🏠 偏安一隅': '顺利毕业且两次拒绝大牛联培和企业实习',
		};
