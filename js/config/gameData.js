		...
		},
		{
			...
			reversed: {
				...
				awakenIcon: '🃏',
				desc: '叛逆是我的代名词',
				bonus: '好感不会低于0，好感归0→重置为6，社交/科研+1，金币<3则重置为3',
				awakenName: '变本加厉',
				awakenDesc: '好感归0→重置为4，金币<5则重置为5，轮流触发社交/科研/社交上限/科研上限+1',
				stats: { favor: 0 }
			}
		},
		{ 
		...
		const ACHIEVEMENT_REQUIREMENTS = {
			...
			'🍚 食之无味': '一篇论文被连续拒稿3次',
			'🤖 机械飞升': '商店购买5台GPU服务器',
			'🛋️ 豪华工位': '同时拥有工学椅+显示器+键盘+GPU服务器+咖啡机（或它们的升级）',
			'🧒 天才少年': '转博时就达到博士毕业要求',
			'💎 无法埋没': '单篇C类论文引用超过100',
			'🔔 不鸣则已': '第一篇论文引用超过200',
			...
			'🪑 高级装备': '升级任意一件装备（工学椅、咖啡机、显示器、自行车等）',
		...
		const shopItems = [
			...
			{ id: 'gemini', name: 'Gemini订阅', desc: '本月想idea时SAN-1，分数+5', price: 2, monthlyOnce: true, boughtThisMonth: false },
			{ id: 'gpt', name: 'GPT订阅', desc: '本月做实验时SAN-1，分数+5', price: 3, monthlyOnce: true, boughtThisMonth: false },
			{ id: 'claude', name: 'Claude订阅', desc: '本月写论文时SAN-1，分数+5', price: 3, monthlyOnce: true, boughtThisMonth: false },
			{ id: 'gpu_rent', name: '租GPU服务器', desc: '本月做实验多做1次且分数+1', price: 2, once: false },
			{ id: 'gpu_buy', name: '购买GPU服务器', desc: '永久buff-每次做实验多做1次且分数+1', price: 10, once: false },
			{ id: 'chair', name: '人体工学椅', desc: '永久buff-每月SAN值+1', price: 10, once: true, bought: false },
			{ id: 'keyboard', name: '机械键盘', desc: '永久buff-写论文变为SAN-3且分数+1', price: 8, once: true, bought: false },
			{ id: 'monitor', name: '2K显示器', desc: '永久buff-看论文变为SAN-1', price: 8, once: true, bought: false },  // ★★★ 改名：4K→2K ★★★
			{ id: 'coffee_machine', name: '咖啡机', desc: '每累计喝15杯冰美式，SAN回复+1（最多+2）', price: 5, once: true, bought: false },  // ★★★ 新增：咖啡机 ★★★
