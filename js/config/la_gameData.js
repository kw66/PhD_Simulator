...
const LA_CONFERENCES = {
    chinese: {
        1: { A: { name: '文学评论', field: '文学理论' }, B: { name: '中国语文', field: '语言学' }, C: { name: '当代文坛', field: '当代文学' } },
        2: { A: { name: '文学遗产', field: '古代文学' }, B: { name: '文艺研究', field: '文艺理论' }, C: { name: '语言研究', field: '语言学' } },
        3: { A: { name: '中国社会科学', field: '综合' }, B: { name: '外国文学评论', field: '外国文学' }, C: { name: '红楼梦学刊', field: '古典文学' } },
        4: { A: { name: '文学评论', field: '文学理论' }, B: { name: '中国现代文学研究丛刊', field: '现代文学' }, C: { name: '民族文学研究', field: '民族文学' } },
        5: { A: { name: '文学遗产', field: '古代文学' }, B: { name: '古汉语研究', field: '古代汉语' }, C: { name: '世界文学', field: '外国文学' } },
        6: { A: { name: '中国社会科学', field: '综合' }, B: { name: '文艺理论与批评', field: '文艺理论' }, C: { name: '当代作家评论', field: '当代文学' } },
        7: { A: { name: '文学评论', field: '文学理论' }, B: { name: '鲁迅研究月刊', field: '鲁迅研究' }, C: { name: '明清小说研究', field: '古典小说' } },
        8: { A: { name: '文学遗产', field: '古代文学' }, B: { name: '诗探索', field: '诗歌研究' }, C: { name: '新文学史料', field: '现代文学' } },
        9: { A: { name: '中国社会科学', field: '综合' }, B: { name: '中国比较文学', field: '比较文学' }, C: { name: '华文文学', field: '海外华文' } },
        10: { A: { name: '文学评论', field: '文学理论' }, B: { name: '小说评论', field: '小说研究' }, C: { name: '南方文坛', field: '当代文学' } },
        11: { A: { name: '文学遗产', field: '古代文学' }, B: { name: '民族艺术', field: '民族艺术' }, C: { name: '扬子江文学评论', field: '当代文学' } },
        12: { A: { name: '中国社会科学', field: '综合' }, B: { name: '文艺争鸣', field: '文艺理论' }, C: { name: '中国文学批评', field: '文学批评' } }
    },
    history: {
        1: { A: { name: '历史研究', field: '历史学' }, B: { name: '中国史研究', field: '中国古代史' }, C: { name: '史学月刊', field: '史学理论' } },
        2: { A: { name: '中国社会科学', field: '综合' }, B: { name: '近代史研究', field: '近现代史' }, C: { name: '历史教学', field: '历史教育' } },
        3: { A: { name: '历史研究', field: '历史学' }, B: { name: '世界历史', field: '世界史' }, C: { name: '中国历史地理论丛', field: '历史地理' } },
        4: { A: { name: '中国社会科学', field: '综合' }, B: { name: '考古学报', field: '考古学' }, C: { name: '史学集刊', field: '史学理论' } },
        5: { A: { name: '历史研究', field: '历史学' }, B: { name: '中国经济史研究', field: '经济史' }, C: { name: '文献', field: '文献学' } },
        6: { A: { name: '中国社会科学', field: '综合' }, B: { name: '抗日战争研究', field: '抗战史' }, C: { name: '清史研究', field: '清史' } },
        7: { A: { name: '历史研究', field: '历史学' }, B: { name: '中国社会经济史研究', field: '社会经济史' }, C: { name: '安徽史学', field: '地方史' } },
        8: { A: { name: '中国社会科学', field: '综合' }, B: { name: '史学理论研究', field: '史学理论' }, C: { name: '中国史研究动态', field: '学术动态' } },
        9: { A: { name: '历史研究', field: '历史学' }, B: { name: '当代中国史研究', field: '当代史' }, C: { name: '西域研究', field: '边疆史' } },
        10: { A: { name: '中国社会科学', field: '综合' }, B: { name: '中华文史论丛', field: '文史' }, C: { name: '民国档案', field: '民国史' } },
        11: { A: { name: '历史研究', field: '历史学' }, B: { name: '中国农史', field: '农业史' }, C: { name: '农业考古', field: '考古' } },
        12: { A: { name: '中国社会科学', field: '综合' }, B: { name: '文物', field: '文物考古' }, C: { name: '中国地方志', field: '方志学' } }
    },
    philosophy: {
        1: { A: { name: '哲学研究', field: '哲学' }, B: { name: '道德与文明', field: '伦理学' }, C: { name: '哲学动态', field: '哲学动态' } },
        2: { A: { name: '中国社会科学', field: '综合' }, B: { name: '自然辩证法研究', field: '科技哲学' }, C: { name: '伦理学研究', field: '伦理学' } },
        3: { A: { name: '哲学研究', field: '哲学' }, B: { name: '中国哲学史', field: '中国哲学' }, C: { name: '世界哲学', field: '外国哲学' } },
        4: { A: { name: '中国社会科学', field: '综合' }, B: { name: '现代哲学', field: '现代哲学' }, C: { name: '科学技术哲学研究', field: '科技哲学' } },
        5: { A: { name: '哲学研究', field: '哲学' }, B: { name: '逻辑学研究', field: '逻辑学' }, C: { name: '中国儒学', field: '儒学' } },
        6: { A: { name: '中国社会科学', field: '综合' }, B: { name: '马克思主义与现实', field: '马哲' }, C: { name: '孔子研究', field: '儒学' } },
        7: { A: { name: '哲学研究', field: '哲学' }, B: { name: '伦理学术', field: '伦理学' }, C: { name: '哲学分析', field: '分析哲学' } },
        8: { A: { name: '中国社会科学', field: '综合' }, B: { name: '周易研究', field: '易学' }, C: { name: '道家文化研究', field: '道家' } },
        9: { A: { name: '哲学研究', field: '哲学' }, B: { name: '宗教学研究', field: '宗教学' }, C: { name: '基督宗教研究', field: '宗教' } },
        10: { A: { name: '中国社会科学', field: '综合' }, B: { name: '美学', field: '美学' }, C: { name: '文艺理论研究', field: '文艺理论' } },
        11: { A: { name: '哲学研究', field: '哲学' }, B: { name: '科学学研究', field: '科学学' }, C: { name: '自然辩证法通讯', field: '科技哲学' } },
        12: { A: { name: '中国社会科学', field: '综合' }, B: { name: '马克思主义研究', field: '马哲' }, C: { name: '当代中国价值观研究', field: '价值论' } }
    },
    foreign_lang: {
        1: { A: { name: '外语教学与研究', field: '外语教学' }, B: { name: '外国语', field: '语言学' }, C: { name: '外语学刊', field: '外语研究' } },
        2: { A: { name: '中国翻译', field: '翻译学' }, B: { name: '现代外语', field: '语言学' }, C: { name: '外语教学', field: '教学法' } },
        3: { A: { name: '外语教学与研究', field: '外语教学' }, B: { name: '外国文学', field: '文学' }, C: { name: '外国语文', field: '综合' } },
        4: { A: { name: '中国翻译', field: '翻译学' }, B: { name: '外语界', field: '教学' }, C: { name: '中国外语', field: '综合' } },
        5: { A: { name: '外语教学与研究', field: '外语教学' }, B: { name: '当代语言学', field: '语言学' }, C: { name: '外语研究', field: '综合' } },
        6: { A: { name: '中国翻译', field: '翻译学' }, B: { name: '外国文学评论', field: '文学评论' }, C: { name: '天津外国语大学学报', field: '综合' } },
        7: { A: { name: '外语教学与研究', field: '外语教学' }, B: { name: '语言教学与研究', field: '教学' }, C: { name: '北京第二外国语学院学报', field: '综合' } },
        8: { A: { name: '中国翻译', field: '翻译学' }, B: { name: '中国比较文学', field: '比较文学' }, C: { name: '上海翻译', field: '翻译' } },
        9: { A: { name: '外语教学与研究', field: '外语教学' }, B: { name: '外语电化教学', field: '教育技术' }, C: { name: '西安外国语大学学报', field: '综合' } },
        10: { A: { name: '中国翻译', field: '翻译学' }, B: { name: '外语与外语教学', field: '教学' }, C: { name: '广东外语外贸大学学报', field: '综合' } },
        11: { A: { name: '外语教学与研究', field: '外语教学' }, B: { name: '日语学习与研究', field: '日语' }, C: { name: '解放军外国语学院学报', field: '综合' } },
        12: { A: { name: '中国翻译', field: '翻译学' }, B: { name: '外语教育研究前沿', field: '教育' }, C: { name: '山东外语教学', field: '教学' } }
    },
    journalism: {
        1: { A: { name: '新闻与传播研究', field: '新闻传播' }, B: { name: '现代传播', field: '传播学' }, C: { name: '新闻记者', field: '新闻实务' } },
        2: { A: { name: '中国社会科学', field: '综合' }, B: { name: '国际新闻界', field: '国际传播' }, C: { name: '传媒观察', field: '传媒' } },
        3: { A: { name: '新闻与传播研究', field: '新闻传播' }, B: { name: '新闻大学', field: '新闻学' }, C: { name: '中国报业', field: '报业' } },
        4: { A: { name: '中国社会科学', field: '综合' }, B: { name: '编辑之友', field: '编辑学' }, C: { name: '新闻界', field: '新闻学' } },
        5: { A: { name: '新闻与传播研究', field: '新闻传播' }, B: { name: '当代传播', field: '传播学' }, C: { name: '青年记者', field: '新闻实务' } },
        6: { A: { name: '中国社会科学', field: '综合' }, B: { name: '新闻与写作', field: '写作' }, C: { name: '中国记者', field: '记者' } },
        7: { A: { name: '新闻与传播研究', field: '新闻传播' }, B: { name: '中国广播电视学刊', field: '广播电视' }, C: { name: '电视研究', field: '电视' } },
        8: { A: { name: '中国社会科学', field: '综合' }, B: { name: '广告大观', field: '广告' }, C: { name: '中国广告', field: '广告' } },
        9: { A: { name: '新闻与传播研究', field: '新闻传播' }, B: { name: '全球传媒学刊', field: '全球传播' }, C: { name: '对外传播', field: '对外传播' } },
        10: { A: { name: '中国社会科学', field: '综合' }, B: { name: '新媒体研究', field: '新媒体' }, C: { name: '网络传播', field: '网络传播' } },
        11: { A: { name: '新闻与传播研究', field: '新闻传播' }, B: { name: '中国出版', field: '出版' }, C: { name: '出版广角', field: '出版' } },
        12: { A: { name: '中国社会科学', field: '综合' }, B: { name: '科技与出版', field: '科技出版' }, C: { name: '出版发行研究', field: '发行' } }
    },
    information: {
        1: { A: { name: '中国图书馆学报', field: '图书馆学' }, B: { name: '图书情报工作', field: '情报' }, C: { name: '图书馆杂志', field: '图书馆' } },
        2: { A: { name: '情报学报', field: '情报学' }, B: { name: '出版发行研究', field: '出版' }, C: { name: '现代出版', field: '出版' } },
        3: { A: { name: '中国图书馆学报', field: '图书馆学' }, B: { name: '档案学通讯', field: '档案学' }, C: { name: '图书馆建设', field: '图书馆' } },
        4: { A: { name: '情报学报', field: '情报学' }, B: { name: '大学图书馆学报', field: '高校图书馆' }, C: { name: '图书馆论坛', field: '图书馆' } },
        5: { A: { name: '中国图书馆学报', field: '图书馆学' }, B: { name: '图书馆学研究', field: '图书馆学' }, C: { name: '图书馆工作与研究', field: '图书馆' } },
        6: { A: { name: '情报学报', field: '情报学' }, B: { name: '档案学研究', field: '档案学' }, C: { name: '中国编辑', field: '编辑' } },
        7: { A: { name: '中国图书馆学报', field: '图书馆学' }, B: { name: '情报理论与实践', field: '情报' }, C: { name: '情报科学', field: '情报' } },
        8: { A: { name: '情报学报', field: '情报学' }, B: { name: '图书情报知识', field: '图书情报' }, C: { name: '情报杂志', field: '情报' } },
        9: { A: { name: '中国图书馆学报', field: '图书馆学' }, B: { name: '国家图书馆学刊', field: '国家图书馆' }, C: { name: '图书馆学刊', field: '图书馆' } },
        10: { A: { name: '情报学报', field: '情报学' }, B: { name: '数字图书馆论坛', field: '数字图书馆' }, C: { name: '新世纪图书馆', field: '图书馆' } },
        11: { A: { name: '中国图书馆学报', field: '图书馆学' }, B: { name: '信息资源管理学报', field: '信息管理' }, C: { name: '农业图书情报学报', field: '农业信息' } },
        12: { A: { name: '情报学报', field: '情报学' }, B: { name: '图书馆', field: '图书馆' }, C: { name: '四川图书馆学报', field: '图书馆' } }
    },
    sociology: {
        1: { A: { name: '社会学研究', field: '社会学' }, B: { name: '社会', field: '社会' }, C: { name: '社会科学研究', field: '社会科学' } },
        2: { A: { name: '中国社会科学', field: '综合' }, B: { name: '青年研究', field: '青年' }, C: { name: '社会科学', field: '社会科学' } },
        3: { A: { name: '社会学研究', field: '社会学' }, B: { name: '中国青年研究', field: '青年' }, C: { name: '社会学评论', field: '社会学' } },
        4: { A: { name: '中国社会科学', field: '综合' }, B: { name: '民俗研究', field: '民俗学' }, C: { name: '民俗曲艺', field: '民俗' } },
        5: { A: { name: '社会学研究', field: '社会学' }, B: { name: '民族研究', field: '民族学' }, C: { name: '广西民族研究', field: '民族' } },
        6: { A: { name: '中国社会科学', field: '综合' }, B: { name: '妇女研究论丛', field: '性别研究' }, C: { name: '中华女子学院学报', field: '性别' } },
        7: { A: { name: '社会学研究', field: '社会学' }, B: { name: '人口研究', field: '人口学' }, C: { name: '人口学刊', field: '人口' } },
        8: { A: { name: '中国社会科学', field: '综合' }, B: { name: '中国人口科学', field: '人口' }, C: { name: '南方人口', field: '人口' } },
        9: { A: { name: '社会学研究', field: '社会学' }, B: { name: '社会保障评论', field: '社会保障' }, C: { name: '社会福利', field: '福利' } },
        10: { A: { name: '中国社会科学', field: '综合' }, B: { name: '社会工作', field: '社工' }, C: { name: '社会建设', field: '社会建设' } },
        11: { A: { name: '社会学研究', field: '社会学' }, B: { name: '思想战线', field: '综合' }, C: { name: '云南民族大学学报', field: '民族' } },
        12: { A: { name: '中国社会科学', field: '综合' }, B: { name: '西北民族研究', field: '民族' }, C: { name: '中南民族大学学报', field: '民族' } }
    },
    education: {
        1: { A: { name: '教育研究', field: '教育学' }, B: { name: '华东师范大学学报(教科版)', field: '教育理论' }, C: { name: '教育学报', field: '教育学' } },
        2: { A: { name: '中国社会科学', field: '综合' }, B: { name: '课程·教材·教法', field: '课程教学' }, C: { name: '教育科学研究', field: '教育科研' } },
        3: { A: { name: '教育研究', field: '教育学' }, B: { name: '高等教育研究', field: '高等教育' }, C: { name: '中国高教研究', field: '高教' } },
        4: { A: { name: '中国社会科学', field: '综合' }, B: { name: '比较教育研究', field: '比较教育' }, C: { name: '外国教育研究', field: '外国教育' } },
        5: { A: { name: '教育研究', field: '教育学' }, B: { name: '教师教育研究', field: '教师教育' }, C: { name: '教师教育学报', field: '教师' } },
        6: { A: { name: '中国社会科学', field: '综合' }, B: { name: '学前教育研究', field: '学前教育' }, C: { name: '幼儿教育', field: '幼教' } },
        7: { A: { name: '教育研究', field: '教育学' }, B: { name: '中国特殊教育', field: '特殊教育' }, C: { name: '现代特殊教育', field: '特教' } },
        8: { A: { name: '中国社会科学', field: '综合' }, B: { name: '职业技术教育', field: '职业教育' }, C: { name: '中国职业技术教育', field: '职教' } },
        9: { A: { name: '教育研究', field: '教育学' }, B: { name: '中国远程教育', field: '远程教育' }, C: { name: '现代远程教育研究', field: '远程' } },
        10: { A: { name: '中国社会科学', field: '综合' }, B: { name: '电化教育研究', field: '教育技术' }, C: { name: '现代教育技术', field: '教育技术' } },
        11: { A: { name: '教育研究', field: '教育学' }, B: { name: '教育发展研究', field: '教育发展' }, C: { name: '教育学术月刊', field: '学术' } },
        12: { A: { name: '中国社会科学', field: '综合' }, B: { name: '教育与经济', field: '教育经济' }, C: { name: '湖南师范大学教育科学学报', field: '综合' } }
    }
};
